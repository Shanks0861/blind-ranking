...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({super.key, required this.user, required this.lobbyService, required this.authService});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('Hallo, ${widget.user.displayName}! 👋',
                style: const TextStyle(color: AppColors.textPrimary, fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 4),
            Text(widget.user.isGuest ? 'Du spielst als Gast' : 'Eingeloggt',
            ...
            _bigCard(
              ...
              gradient: const LinearGradient(colors: [Color(0xFFFF6B9D), Color(0xFFFF8C42)]),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 22)),
